...
const handleGitHubLogin = () => {
  const apiUrl = (import.meta as any).env.VITE_API_URL || 'http://localhost:8089'
...
<template>
  <div class="min-h-screen flex bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
    <!-- Left side - Features section -->
    <div class="flex-1 p-12 flex flex-col justify-center relative overflow-hidden w-1/2">
      <!-- Animated background elements -->
      <div class="absolute inset-0 opacity-5">
        <div
          class="absolute top-1/4 left-1/4 w-64 h-64 bg-cyan-400 rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
        <div
          class="absolute top-3/4 right-1/4 w-72 h-72 bg-blue-400 rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-1000"></div>
        <div
          class="absolute bottom-1/4 left-1/3 w-80 h-80 bg-indigo-400 rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-2000"></div>
      </div>
        ...
        <svg class="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          <defs>
            <pattern id="tech-grid" width="20" height="20" patternUnits="userSpaceOnUse">
              <circle cx="10" cy="10" r="1" fill="currentColor" class="text-cyan-400" />
              <path
        ...
        <div class="mb-12">
          ...
          <div class="flex flex-col gap-y-12">
            <div
              ...
              <!-- Lynx Head SVG -->
              <img src="../assets/logo.png" alt="Lynx Head" class="rounded-3xl" />
            </div>
            <div>
              ...
              <p class="text-slate-300 text-md leading-relaxed">
                Advanced task management with intelligent automation. Transform your productivity
        ...
        <div class="gap-y-10 flex flex-col">
          ...
          <div class="flex items-start group gap-x-5">
            ...
            <div class="flex-1 pt-1">
              ...
              <p class="text-slate-300 leading-relaxed text-base">
                Experience blazing-fast task processing with our optimized algorithms and
          ...
          <div class="flex items-start group gap-x-5">
            ...
            <div class="flex-1 pt-1">
              ...
              <p class="text-slate-300 leading-relaxed text-base">
                Seamless team coordination with live updates, instant notifications, and
    ...
    <div
      ...
      <div class="w-full max-w-md relative z-10">
        <div class="p-8 gap-y-5 flex flex-col">
          ...
          <form @submit.prevent="handleSubmit" class="gap-y-5 flex flex-col mt-6">
              ...
              <div>
                <FloatLabel>
                  <InputText
                    ...
                    class="w-full"
                    required />
                  <label for="password" class="!text-slate-600 !font-medium">Password</label>
                </FloatLabel>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between pt-2">
              <div class="flex items-center">
                <Checkbox input-id="remember" v-model="rememberMe" :binary="true" class="!mr-3" />
            ...
            <Divider align="center">
              <span class="!text-slate-400 !bg-white !px-4 !text-sm">or continue with</span>
            </Divider>
